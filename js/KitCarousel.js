			...
			_.extend({
				_init : function (){
					...
					if( !_.o.centerIndex ){
						...
						_.centerIndex = (_.o.centerMode)?_.o.centerIndex:1;
					}
				...
				render : function (t){
					...
					if( _.o.navBlock ){
						$(_.o.navBlock).children().removeClass("active");
						$(_.o.navBlock).children().eq( _.wrap.children("[data-i='" + ( _.centerIndex * 1 + y ) + "']").attr("data-s") - 1 ).addClass("active");
					}
				...
				initHandlers : function(){
					...
					if( _.o.touch ){
						...
						$(document).on( _.isTouch ? "touchmove" : "mousemove", function(y){
							...
							// clearTimeout(_.touchTimer);

							e = _.isTouch ? y.originalEvent.touches[0] : y;

							if( _.isTouch && !_.dragged && Math.abs(_.startX - e.pageX) > _.startOffset && Math.abs(_.startY - e.pageY) < _.startOffset ){
								_.dragged = true;
							}
							...
							// _.touchTimer = setTimeout(function(){
							// 	$(document).mouseup();
							// },1000);
							return false;
						});	
						...
						$(document).on( _.isTouch ? "touchend" : "mouseup", function(y){
							...
							if( len == 0 ){
								if( _.pageOffset != 0 ){
									...
									if( _.points[0] == _.points[_.points.length - 1] && _.points[0] == 0 )
									len = 1;
								}
							}

							// console.log([side, len]);
							// console.log(_.points);
